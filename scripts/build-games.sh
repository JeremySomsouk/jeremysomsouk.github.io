...
RUSTC="$(rustup which --toolchain 1.96.0 rustc)" rustup run 1.96.0 cargo build --manifest-path games/river/Cargo.toml --release --target wasm32-unknown-unknown
cp games/memory/target/wasm32-unknown-unknown/release/memory_game.wasm docs/cabane/memory/game.wasm
cp games/river/target/wasm32-unknown-unknown/release/river_game.wasm docs/cabane/river/game.wasm
